...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(objetoRetornado.fetchMenu()).toEqual({food: {}, drink: {}}) // Retorno: { food: {}, drink: {}}
    // ```
    ...
    expect(objetoRetornado.fetchMenu()).toEqual({food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9}}) // Retorno: objetoQualquer
    // ```
    ...
    it('Verifique se, ao chamar uma função associada à chave `order` no objeto retornado, passando uma string como parâmetro, tal string é adicionada', () => {
    ...
    objetoRetornado.order('agua')
    objetoRetornado.order('coxinha')
    expect(objetoRetornado.pay()).toEqual(27.06)
    })
